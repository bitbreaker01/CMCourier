...
| [`operator/probar-todos-los-tipos.md`](operator/probar-todos-los-tipos.md) | Verificar que TODOS los tipos configurados suben a CM con sus metadatos antes de migrar (158) |
